		...
		<form class="well form-horizontal" name="form_divorcio_partida" id="form_divorcio_partida" action="" method="POST" >
			<fieldset>
				...
				<div class="control-group">
					<div class="controls">
						<button type="button" class="btn" name="btn-buscar-esposo" id="btn-buscar-esposo" data-toggle="modal" href="#buscar-esposo"><i class="icon-search"></i> Buscar Ex-esposo</button>
					</div>
				</div>
				...
				<div class="control-group">
					<div class="controls">
						<button type="button" class="btn" name="btn-buscar-esposa" id="btn-buscar-esposa" data-toggle="modal" href="#buscar-esposa"><i class="icon-search"></i> Buscar Ex-esposa</button>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="date" name="fec_div" id="fec_div">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="input-xxlarge" rows="16" name="cue" id="cue"></textarea>
					</div>
				</div>
