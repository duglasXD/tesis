...
<html lang="es">
	<head>
		<meta charset="utf-8">
		<title>consulta de divorcios</title>
	...
	<body>
		...
		<!-- Inicia area de filtros principales -->
			<legend>Consulta de divorcios</legend>
			...
			<label class="radio" style="margin-left: 25px"><input type="radio" name="opcion" id="fecha" value="fecha"> Fecha del divorcio</label>
		...
		<div class="span12">
			<table class="" id="nacpar" data-toggle="table" data-height="500" data-pagination="true" data-page-list="[10, 20, 50, 100]" data-show-toggle='true' data-show-columns='true' data-search='true'>
				<thead>
					<tr>
						<th data-field="fec_div">Fecha del divorcio</th>
						...
						<th data-field="nom_ape_eso">Nombre del ex-esposo</th>
						<th data-field="nom_ape_esa">Nombre de la ex-esposa</th>
		...
		<script type="text/javascript" >
			...
			function buscar(){
				if($("input[name:opcion]:checked").val() == "nombre"){
					$.ajax({
						type : "post",
						url : "proc_cons_divorcio_partida.php",
						data : {
							"nom" : $("#nom").val()
							},
