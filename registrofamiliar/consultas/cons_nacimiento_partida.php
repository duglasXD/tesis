...
<html lang="es">
	<head>
		<meta charset="utf-8">
		<title>Consulta de partidas de nacimiento</title>
	...
	<body>
		...
		<!-- Inicia area de filtros principales -->
			<legend>Consulta de partidas de nacimiento</legend>
			...
			<label class="radio" style="margin-left: 25px"><input type="radio" name="opcion" id="fecha" value="fecha"> Fecha de nacimiento</label>
			...
			<table class="" id="nacpar" data-toggle="table" data-height="500" data-pagination="true" data-page-list="[10, 20, 50, 100]" data-show-toggle='true' data-show-columns='true' data-search='true'>
				<thead>
					<tr>
						...
						<!-- <th data-field="ape1">1° apellido</th> -->
						<!-- <th data-field="ape2">2° apellido</th> -->
						<th data-field="nom_ape_pad">Nombre del padre</th>
						<th data-field="nom_ape_mad">Nombre de la madre</th>
		...
		<script type="text/javascript" >
			...
			function buscar(){
				if($("input[name:opcion]:checked").val() == "nombre"){
					$.ajax({
						type : "post",
						url : "proc_cons_nacimiento_partida.php",
						data : {
							"nom" : $("#nom").val()
							},
