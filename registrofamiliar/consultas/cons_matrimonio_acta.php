...
<html lang="es">
	<head>
		<meta charset="utf-8">
		<title>Consulta de Actas de Matrimonios</title>
	...
	<body>
		...
		<!-- Inicia area de filtros principales -->
			<legend>Consulta de Actas de Matrimonios</legend>
		...
		<script type="text/javascript" >
			...
			function buscar(){
				if($("input[name:opcion]:checked").val() == "nombre"){
					$.ajax({
						type : "post",
						url : "proc_cons_matrimonio_acta.php",
						data : {
							"nom" : $("#nom").val()
							},
