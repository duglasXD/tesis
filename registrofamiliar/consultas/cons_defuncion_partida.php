...
<html lang="es">
	<head>
		<meta charset="utf-8">
		<title>consulta de defunciones</title>
	...
	<body>
		...
		<!-- Inicia area de filtros principales -->
			<legend>Consulta de partidas de defunción</legend>
			...
			<label class="radio" style="margin-left: 25px"><input type="radio" name="opcion" id="fecha" value="fecha"> Fecha de defunción</label>
		...
		<div class="span12">
			<table class="" id="nacpar" data-toggle="table" data-height="500" data-pagination="true" data-page-list="[10, 20, 50, 100]" data-show-toggle='true' data-show-columns='true' data-search='true'>
				<thead>
					<tr>
						<th data-field="fec_def">Fecha de defuncion</th>
						...
						<th data-field="nom_ape">Nombre</th>
						<th data-field="cau_def">Causa de la muerte</th>
		...
		<script type="text/javascript" >
			...
			function buscar(){
				if($("input[name:opcion]:checked").val() == "nombre"){
					$.ajax({
						type : "post",
						url : "proc_cons_defuncion_partida.php",
						data : {
							"nom" : $("#nom").val()
							},
