<!DOCTYPE html>
	...
	<head>
		...
		<script src="js/cons_activo.js"></script>
	</head>
	<body>

		<div class="well row">
				<legend>Consulta de Activos</legend>
				...
				<div class="span3">
					<label class="radio inline"><input type="radio" name="radBus" value="Marca" >Marca</label>
				</div>
				
				<div class="span3">
					<label class="radio inline"><input type="radio" name="radBus" value="Modelo" >Modelo</label>
				</div>
				<div class="span3">
					<label class="radio inline"><input type="radio" name="radBus" value="Tipo" id="tipo" >Tipo de Fondos</label>
				</div>
				<div class="span3">
					<label class="radio inline"><input type="radio" name="radBus" value="Adquisicion" >Adquisicion</label>
				</div>
				<div class="span3">
					<label class="radio inline"><input type="radio" name="radBus" value="Garantia" >Garantia</label>
				</div>
				<div class="span12">
		...
		<table data-toggle='table' data-height='500' data-pagination="true" data-page-list="[10, 20, 50, 100]" data-show-toggle='true' data-show-columns='true' data-search='true' data-select-item-name='toolbar1' id="tablaR">
			<thead>
				<tr>
					...
					<th data-field='mar' data-visible="false">Marca</th>
					<th data-field='mod' data-visible="false">Modelo</th>
					<th data-field='ser'>Serie</th>
					<th data-field='cos_adq'>Costo de Adquisicion</th>
					<th data-field='ori'>Origen</th>
					<th data-field='depto'>Departamento</th>
					<th data-field='fec_adq'>Fecha de adquisicion</th>
					<th data-field='fec_gar' data-visible="false">Fecha de Garantía</th>
				</tr>
		 	</thead>
		</table>
		</div>
