<!DOCTYPE html>
	...
	<body>
		...
		<div class="well row">
				<legend>Consulta de Reparaciones</legend>
				...
				<div class="span3">
					<label class="radio inline"><input type="radio" name="radBus" value="Empresa" >Empresa</label>
				</div>
				...
				<div class="span3">
					<label class="radio inline"><input type="radio" name="radBus" value="Costo" >Costo</label>
				</div>
				<div class="span12">
		...
		<table data-toggle='table' data-height='500' data-pagination="true" data-page-list="[10, 20, 50, 100]" data-show-toggle='true' data-show-columns='true' data-search='true' data-select-item-name='toolbar1' id="tablaR">
			<thead>
				<tr>
					...
					<th data-field='cos'>Costo</th>
					<th data-field='emp'>empresa</th>
					<th data-field='des' data-visible="false">Descripcion</th>
				</tr>
		 	</thead>
		</table>
		</div>
