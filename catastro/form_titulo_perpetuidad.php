...
<body>
	...
	<form class="well form-horizontal span12" id="formulario">
		...
		<div class="control-group span5">
			...
			<div class="controls">
				<input type="number" class="input-mini" value="1" min="0" max="5" id="nic_aut" name="nic_aut">
			</div>
		</div>
		...
		<?php 
		$rs=pg_query("SELECT cob_fij FROM co_impuesto WHERE codigo='12111'");
		...
		<div class="control-group span5">
			...
			<div class="controls">
                    <div class="input-prepend">
                        ...
                        <input type="text" class="span2" id="valor" name="valor" value="<?php echo $valorp;pg_close($conn); ?>" readonly>
                    </div>
                </div>
		</div>
		<div class="control-group span6">
